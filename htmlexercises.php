...
<body >
  ...
  <section id="Services">
    ...
    ";
        ...
        $sql="SELECT * FROM htmlex ORDER BY RAND() LIMIT 1";
        $sorgu=mysqli_query($conn,$sql);
        while( $sonuc=mysqli_fetch_assoc($sorgu) ){
          echo "<h3> Your exercise for:" . date("d/m/y") . "<h3/><br>";
          echo '<h1>'.$sonuc["title"]."</h1><br/><br/>" ;
          echo '<img src="test/'.$sonuc["image"].'" alt="Exercise" width="420" height="450" style="  right:470px""><br/><br/>';//title;
          echo '<h4 style="  right:200px;bottom:420px">'.$sonuc["text"]. "</h4><br><br><br><br>";
          echo '<a href="htmlexercises.php?get=imdone#container"><input type="submit" name="submit" value="I am done!" class="classname""/></a>';
              }
              @$a=$_GET["get"];
            switch ($a) {
              case 'imdone':
